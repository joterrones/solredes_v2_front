...
@Component({
  ...
  templateUrl: './mapa-general2.component.html',
  styleUrls: ['./mapa-general2.component.css'],
  providers: [SeguridadService, confGeneralService, MapaService]
})
export class MapaGeneral2Component extends BaseComponent implements OnInit {
        ...
        switch (element.version) {
          case 1:
            /* if (checkOk.filter(o => o.completed && o.id == 1).length > 0) {
              ...
              this.tileAtributosExpLP = this.customTileLayer('solredes:punto2', "n_version =1 and n_idpl_tipolinea = 1 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 2).length > 0) {
              ...
              this.tileAtributosExpRP = this.customTileLayer('solredes:punto2', "n_version =1 and n_idpl_tipolinea = 2 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 3).length > 0) {
              ...
              this.tileAtributosExpRS = this.customTileLayer('solredes:punto2', "n_version =1 and n_idpl_tipolinea = 3 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
          ...
          case 3:
            /* if (checkOk.filter(o => o.completed && o.id == 1).length > 0) {
              ...
              this.tileAtributosMonLP = this.customTileLayer('solredes:punto2', "n_version =3 and n_idpl_tipolinea = 1 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 2).length > 0) {
              ...
              this.tileAtributosMonRP = this.customTileLayer('solredes:punto2', "n_version =3 and n_idpl_tipolinea = 2 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 3).length > 0) {
              ...
              this.tileAtributosMonRS = this.customTileLayer('solredes:punto2', "n_version =3 and n_idpl_tipolinea = 3 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
          ...
          case 4:
            /* if (checkOk.filter(o => o.completed && o.id == 1).length > 0) {
              ...
              this.tileAtributosConLP = this.customTileLayer('solredes:punto2', "n_version =4 and n_idpl_tipolinea = 1 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 2).length > 0) {
              ...
              this.tileAtributosConRP = this.customTileLayer('solredes:punto2', "n_version =4 and n_idpl_tipolinea = 2 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 3).length > 0) {
              ...
              this.tileAtributosConRS = this.customTileLayer('solredes:punto2', "n_version =4 and n_idpl_tipolinea = 3 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
          ...
          case 5:
            /* if (checkOk.filter(o => o.completed && o.id == 1).length > 0) {
              ...
              this.tileAtributosMonInspReplantLP = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 2 and n_idpl_tipolinea = 1 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 2).length > 0) {
              ...
              this.tileAtributosMonInspReplantRP = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 2 and n_idpl_tipolinea = 2 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 3).length > 0) {
              ...
              this.tileAtributosMonInspReplantRS = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 2 and n_idpl_tipolinea = 3 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
          ...
          case 6:
            /* if (checkOk.filter(o => o.completed && o.id == 1).length > 0) {
              ...
              this.tileAtributosMonInspMontLP = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 3 and n_idpl_tipolinea = 1 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 2).length > 0) {
              ...
              this.tileAtributosMonInspMontRP = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 3 and n_idpl_tipolinea = 2 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 3).length > 0) {
              ...
              this.tileAtributosMonInspMontRS = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 3 and n_idpl_tipolinea = 3 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
          ...
          case 7:
            /* if (checkOk.filter(o => o.completed && o.id == 1).length > 0) {
              ...
              this.tileAtributosMonInspConfObraLP = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 4 and n_idpl_tipolinea = 1 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 2).length > 0) {
              ...
              this.tileAtributosMonInspConfObraRP = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 4 and n_idpl_tipolinea = 2 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
            ...
            if (checkOk.filter(o => o.completed && o.id == 3).length > 0) {
              ...
              this.tileAtributosMonInspConfObraRS = this.customTileLayer('solredes:puntoMonInsp2', "n_tipoapp = 4 and n_idpl_tipolinea = 3 and n_idpro_proyecto = " + this.proyecto.n_idpro_proyecto);
