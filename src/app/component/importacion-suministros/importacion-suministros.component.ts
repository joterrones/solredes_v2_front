...
@Component({
  ...
  templateUrl: './importacion-suministros.component.html',
...
export class ImportacionSuministrosComponent extends BaseComponent implements OnInit {
  ...
  conexionapi(tipo: number) {
    ...
    datosenvio.forEach(element => {
      ...
      if (element.CODIGO_SUMINISTRO == null) { element.CODIGO_SUMINISTRO = "" } 
      if (element.DESCRIPCION_SUMINISTRO == null) { element.DESCRIPCION_SUMINISTRO = "" }
