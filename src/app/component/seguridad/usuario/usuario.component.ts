...
export class UsuarioComponent extends BaseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['editar', 'username', 'c_nombre', 'c_dni', 'c_telefono', 'c_role', 'c_entidad', 'resetear', 'eliminar'];
  ...
  selectRole(n_idseg_role) {
    this.idroles = n_idseg_role;
    this.getTablaUsuario();
  }
