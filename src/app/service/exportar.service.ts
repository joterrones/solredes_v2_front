...
export class ExportarService {
    ...
    exportarExcelPlanilla( datos: any[], datos2: any[]):void{
        console.log(datos);
        console.log(datos2);
        ...
        datos.forEach(element => {
            ...
            worksheet.getCell('O' + row).alignment = { vertical: 'middle', horizontal: 'center' };
            this.setdatogeneral(worksheet, 'O' + row, element.n_cantidadea, 10, false);
            worksheet.getCell('O' + row).border = {
                left: { style: 'thin' },
                right: { style: 'thin' },
                bottom: { style: 'thin' },
            ...
            worksheet.getCell('P' + row).alignment = { vertical: 'middle', horizontal: 'center' };
            this.setdatogeneral(worksheet, 'P' + row, element.c_etiquetaestructura, 10, false);
            worksheet.getCell('P' + row).border = {
                left: { style: 'thin' },
                right: { style: 'thin' },
                bottom: { style: 'thin' },
            ...
            datos2.forEach(element2 => {
                
                if( element.n_idpl_estructuraarmado == element2.n_idpl_estructuraarmado ){
                    cont++;
                    switch (element2.c_codigo) {
                        case 'Amortiguador_35':
                            worksheet.getCell('W' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'W' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('W' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                            ...
                            break; 
                        case 'Amortiguador_70':
                            worksheet.getCell('X' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'X' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('X' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RI-A':
                            worksheet.getCell('Y' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'Y' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('Y' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RV-A':
                            worksheet.getCell('Z' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'Z' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('Z' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RI-MT':
                            worksheet.getCell('AA' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AA' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AA' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RV-MT':
                            worksheet.getCell('AB' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AB' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AB' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RI':
                            worksheet.getCell('AC' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AC' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AC' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RV':
                            worksheet.getCell('AD' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AD' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AD' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RIY':
                            worksheet.getCell('AE' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AE' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AE' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'RVY':
                            worksheet.getCell('AF' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AF' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AF' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-1':
                            worksheet.getCell('AG' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AG' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AG' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-1C':
                            worksheet.getCell('AH' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AH' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AH' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-2':
                            worksheet.getCell('AI' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AI' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AI' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-3':
                            worksheet.getCell('AJ' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AJ' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AJ' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-1CS':
                            worksheet.getCell('AK' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AK' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AK' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-2S':
                            worksheet.getCell('AL' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AL' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AL' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-3S':
                            worksheet.getCell('AM' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AM' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AM' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'PAT-1S': 
                            worksheet.getCell('AN' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AN' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AN' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'AP_BT': 
                            worksheet.getCell('AQ' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AQ' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AQ' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
                        ...
                        case 'AP_MT': 
                            worksheet.getCell('AS' + row).alignment = { vertical: 'middle', horizontal: 'center' };
                            this.setdatogeneral(worksheet, 'AS' + row, element2.n_cantidad, 10, false);
                            worksheet.getCell('AS' + row).border = {
                                left: { style: 'thin' },
                                right: { style: 'thin' },
                                bottom: { style: 'thin' },
